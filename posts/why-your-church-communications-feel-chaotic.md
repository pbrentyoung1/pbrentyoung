...
Lucy and Ethel take a job wrapping chocolates on a conveyor belt. The rule is simple: don't let a single piece get by unwrapped. Then the belt speeds up. They wrap faster. It speeds up again. Soon they are stuffing chocolates in their mouths, their hats, and their blouses, doing anything to hide the fact that the line has beaten them. They are working as hard as two people can work, and they are losing badly.
...
"Can you promote the men's breakfast?" sounds like one task. It is actually a stack of undecided questions: Who is it for? What do they need to know? Which channels? By when? Who approves it? What gets bumped to make room? When none of those are decided, the communications person does not just do the work. They absorb the ambiguity. Multiply that by every ministry, every week, and you get a job where the actual craft happens in the leftover minutes between negotiations.

> ! Chaos is what unmade decisions feel like when they land on one person's desk.

## In a church, every chocolate has a face
